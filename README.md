...
<details>
  ...
  - Server: port: `3000` (all request on port 80 (http) get redirected to this port), host name: `looped.portal`
...
Access the URL `looped.portal` in your browser. Also make sure that the server serving the static HTML pages is up and running:
